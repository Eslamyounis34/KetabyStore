...
public class ReligiousNovels extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_religious_novels);

        recyclerView=findViewById(R.id.recyclerforreligiouscategory);
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("روايات دينيه");
        toolbarTextView.setText("روايات دينية");
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                GridLayoutManager layoutManager = new GridLayoutManager(ReligiousNovels.this,3, LinearLayoutManager.VERTICAL, false);
